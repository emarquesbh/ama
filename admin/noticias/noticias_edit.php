<?php
// admin/noticias/noticias_edit.php
...
<body class="container mt-4">
    <h2>Editar Registro - Notícias</h2>
    <form method="post" action="processar_noticias.php">
        ...
        <a href="listar_noticias.php" class="btn btn-secondary">Cancelar</a>
    </form>
</body>
</html>