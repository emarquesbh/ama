<?php
// admin/vida_ativa/vida_ativa_edit.php
...
$id = intval($_GET["id"]);
$stmt = $mysqli->prepare("SELECT * FROM vida_ativa WHERE id = ?");
...
<body class="container mt-4">
    <h2>Editar Registro - Vida Ativa</h2>
    <form method="post" action="processar_vida_ativa.php">
        ...
        <a href="listar_vida_ativa.php" class="btn btn-secondary">Cancelar</a>
    </form>
</body>
</html>