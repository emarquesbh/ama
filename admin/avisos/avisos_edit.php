...
$id = intval($_GET["id"]);
$stmt = $mysqli->prepare("SELECT * FROM avisos WHERE id = ?");
...
<body class="container mt-4">
    <h2>Editar Registro - Avisos</h2>
    <form method="post" action="processar_avisos.php">
        ...
        <a href="listar_avisos.php" class="btn btn-secondary">Cancelar</a>
    </form>
</body>
</html>
