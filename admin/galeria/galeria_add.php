...
<body class="container mt-4">
    <h2>Adicionar Novo - Galeria</h2>
    <form method="post" action="processar_galeria.php">
        ...
        <a href="listar_galeria.php" class="btn btn-secondary">Cancelar</a>
    </form>
</body>
</html>
