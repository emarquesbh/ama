<?php
// admin/grupo_reflexao/grupo_reflexao_edit.php
...
$id = intval($_GET["id"]);
$stmt = $mysqli->prepare("SELECT * FROM grupo_reflexao WHERE id = ?");
...
<body class="container mt-4">
    ...
    <form method="post" action="processar_grupo_reflexao.php">
        ...
        <a href="listar_grupo_reflexao.php" class="btn btn-secondary">Cancelar</a>
    </form>
</body>
</html>