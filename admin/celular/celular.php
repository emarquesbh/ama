<?php
// celular.php
// Formulário de cadastro de aula de Celular
...
?>
<div class="container">
    <h1 class="mb-4">Cadastrar Aula de Celular</h1>
    <form action="processar_celular.php" method="post" enctype="multipart/form-data">
        <div class="mb-3">
