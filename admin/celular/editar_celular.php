<?php
// editar_celular.php
// Tela de edição de aula de Celular
...
// Obter ID
$id = (int) $_GET['id'];
$registro = $mysqli->query("SELECT * FROM celular WHERE id = $id")->fetch_assoc();
...
?>
<div class="container">
    <h1 class="mb-4">Editar Aula de Celular</h1>
    <form action="processar_celular.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label>Imagem atual:</label><br>
            <?php if (!empty($registro['imagem'])): ?>
                <img src="../uploads/celular/<?php echo htmlspecialchars($registro['imagem']); ?>" alt="Imagem" style="width: 150px; height: auto;">
            <?php else: ?>
                Sem imagem
            <?php endif; ?>
        </div>
