...
<?php
// admin/lian_gong/lian_gong_edit.php
...
$id = intval($_GET["id"]);
$stmt = $mysqli->prepare("SELECT * FROM lian_gong WHERE id = ?");
...
<body class="container mt-4">
    <h2>Editar Registro - Lian Gong</h2>
    <form method="post" action="processar_lian_gong.php">
        ...
        <a href="listar_lian_gong.php" class="btn btn-secondary">Cancelar</a>
    </form>
</body>
</html>