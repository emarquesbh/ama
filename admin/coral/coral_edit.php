...
$id = intval($_GET["id"]);
$stmt = $mysqli->prepare("SELECT * FROM coral WHERE id = ?");
...
<body class="container mt-4">
    <h2>Editar Registro - Coral</h2>
    <form method="post" action="processar_coral.php">
        ...
        <a href="listar_coral.php" class="btn btn-secondary">Cancelar</a>
    </form>
</body>
</html>