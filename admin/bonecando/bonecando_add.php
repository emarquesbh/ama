<?php
// admin/bonecando/bonecando_add.php
?>
...
<head>
    <meta charset="UTF-8">
    <title>Adicionar Bonecando</title>
...
<body class="container mt-4">
    <h2>Adicionar Novo - Bonecando</h2>
    <form method="post" action="processar_bonecando.php">
        ...
        <a href="listar_bonecando.php" class="btn btn-secondary">Cancelar</a>
    </form>
</body>
</html>